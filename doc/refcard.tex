...
\begin{footnotesize}
\section*{\Large amforth 4.1 Reference Card}
\begin{multicols}{3}
...
\verb|/pad|  & \verb/( -- n )/\\
% XT_ENV_CPU
\verb|cpu|  & \verb/( -- addr len )/\\
% XT_ENV_FORTHNAME
\verb|forth-name|  & \verb/( -- addr len )/\\
% XT_ENV_FORTHVERSION
\verb|version|  & \verb/( -- addr len )/\\
\end{tabular}
